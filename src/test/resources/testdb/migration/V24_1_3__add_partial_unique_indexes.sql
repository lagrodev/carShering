...
ALTER TABLE car_rental.document
    DROP CONSTRAINT IF EXISTS ukfkkhgus997mjuggrw70m9tgg9;
...
CREATE UNIQUE INDEX uk_document_client_active ON car_rental.document (client_id) WHERE is_deleted = false;
INSERT INTO car_rental.rental_state (name) VALUES ('CANCELLATION_REQUESTED');