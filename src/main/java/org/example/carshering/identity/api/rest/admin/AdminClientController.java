...
public class AdminClientController {
    ...
    public AllUserResponse getUser(
        ...
        return clientResponseFacade.getAllUserResponse(clientService.findUser(userId));
    }
    ...
    public Page<ShortUserResponse> getAllUsers(
        ...
        // todo roleRepository to get roleId by roleName
        // temporary assignment, replace with actual roleId retrieval logic
        return clientService.filterUsersByRoleName(banned, roleName, pageable)
                .map(clientResponseFacade::getShortUserById);
    }
    ...
    public ResponseEntity<?> updateRole(
        ...
        var client = clientService.updateRoleByName(userId, roleRequested.RoleName());
