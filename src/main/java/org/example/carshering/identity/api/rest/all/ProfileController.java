...
public class ProfileController {
    ...
    public ResponseEntity<?> getProfile(
        ...
        UserResponse user = clientResponseFacade.getClientById(clientService.findUser(userId));
    ...
    public ResponseEntity<?> getDocument(Authentication auth) {
        Long userId = getCurrentUserId(auth);
        DocumentResponse doc = clientResponseFacade.getDocumentResponse(clientService.findDocument(userId));
        if (doc == null) {
            return ResponseEntity.noContent().build();
        }
    ...
    public ResponseEntity<?> deleteDocument(Authentication auth) {
        Long userId = getCurrentUserId(auth);
        clientService.deleteDocument(userId);
        return ResponseEntity.noContent().build();
    }
    ...
    public ResponseEntity<?> verifyEmail(
        ...
        Long userId = getCurrentUserId(auth);
        VerifyStatusResponse response = clientService.sendForVerifyEmail(userId);
