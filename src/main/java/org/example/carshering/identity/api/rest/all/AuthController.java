...
import org.example.carshering.identity.application.service.auth.AuthApplicationService;
...
public class AuthController {
    ...
    public ResponseEntity<?> createNewUser(
        ...
        UserResponse userResponse = clientResponseFacade.getClientById(this.clientService.createUser(request));
    ...
    public ResponseEntity<Void> resetPasswordToken(
        ...
        clientService.resetPassword(code, request);
