...
public class Password {
    ...
    /**
     * Checks if the provided plain password matches this encoded password.
     *
     * This method is used for authentication/password verification.
     *
     * @param plainPassword plain text password to check
     * @return true if plain password matches the encoded password, false otherwise
     */
    public boolean matches(String plainPassword) {
        ...
        if (!this.isEncoded()) {
            throw new IllegalStateException("Cannot check match: stored password is not encoded");
        }

        // Use BCryptPasswordEncoder for verification
